# 13.4.3 Consulting Single Parameter: no version element - Test Case
# Client side.
...
def script(conn):
    ...
    assert_equals(msg.tcu_data.items[0].type, 0x47)
    ...
    reply.tcu_data.items[0].type = 0x47
    reply.tcu_data.items[0].data = 0
