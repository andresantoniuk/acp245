...
def script(conn):
    msg = ProvUpd(
       ...
       #version=0x02                            # Version 0x02=ACP245 1.2.2, part of the IEHeader class
        ...
        end_time=IETimestamp(
            year=2014,                              #Set to 2014 for changes to take immediate effect
            month=5,
            day=30
        ),
        vehicle_desc=IEVehicleDesc(
            imei="89460800120005331333",               
