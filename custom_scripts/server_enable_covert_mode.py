# Enable COVERT mode: based on standard script 13.5.1
...
def script(conn):
    ...
    # Set entity ID to COVERT MODE
    msg.ctrl_func.entity_id=2
    ...
    assert_equals(reply.ctrl_func.entity_id, 2)

    assert_equals(reply.func_status.cmd, 2)
