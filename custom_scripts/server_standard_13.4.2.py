# 13.4.2 Updating Multiple Parameters without version element - Test Case
# Server side.
...
def script(conn):
    ...
    assert_equals(reply.error.items[0].type, 0x11)
    assert_equals(reply.error.items[0].error.code, 0x00)
    assert_equals(reply.error.items[1].type, 0x19)
    assert_equals(reply.error.items[1].error.code, 0x00)
    assert_equals(reply.error.items[2].type, 0x51)
    assert_equals(reply.error.items[2].error.code, 0x00)
